...
import com.lpaxxa.coffee.entity.Category;
...
public class ProductController {
    ...
    public List<Category> getCategories() {
        List<Category> categories = List.of(
                new Category(1L, "Cà phê", "Các loại cà phê"),
                new Category(2L, "Trà", "Các loại trà"),
                new Category(3L, "Nước giải khát", "Các loại nước giải khát")
        );
        return categories;
    ...
    public String create(Model model) {
        ...
        model.addAttribute("cates", getCategories()); // gửi danh sách category vào form


   return "product-form";
    }
    @PostMapping("/products/save")
    public String save(@ModelAttribute("selectedProduct") Product product, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("selectedName",product.getName());
